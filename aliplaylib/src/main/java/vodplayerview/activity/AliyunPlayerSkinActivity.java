...
import com.yjplay.aliplaylib.R;
...
import vodplayerview.utils.Common;
import vodplayerview.utils.FixedToastUtils;
...
public class AliyunPlayerSkinActivity extends BaseActivity {
    ...
    private void initVideoListView() {
        ...
        tvVideoList.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                downloadView.changeDownloadEditState(false);
    ...
    private void initLogView() {
        ...
        //日志清除
        llClearLogs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                logStrs.clear();
                tvLogs.setText("");
        ...
        tvTabLogs.setOnClickListener(new View.OnClickListener() {

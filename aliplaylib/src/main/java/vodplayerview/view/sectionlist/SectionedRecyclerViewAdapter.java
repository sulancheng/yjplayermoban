...
/**
 * A custom RecyclerView Adapter that allows { Section Sections} to be added to it.
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} with the position of the {}
    ...
    /**
     * Helper method that calls {} and {} with

...
//                fos.close();
     ...
     * @return
     */
    private static StringBuffer getTraceInfo(Throwable e) {
        StringBuffer sb = new StringBuffer();
    ...
    private static String getDpath(String filename) {
        String folderPath = null;
        CommenUtils.getdownloadPath("imgs");
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            folderPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/bijiami/" + filename;
        } else {
            folderPath = Environment.getDataDirectory().getAbsolutePath() + "/data/bijiami/" + filename;
        }
        return folderPath;
    }

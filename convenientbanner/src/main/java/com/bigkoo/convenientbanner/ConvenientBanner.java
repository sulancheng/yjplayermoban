...
//        initheightwith();
    ...
    public ConvenientBanner setViewpagerLarm(int height){
    ...
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        ...
        layoutParams.leftMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8,mcontext.getResources().getDisplayMetrics());
        layoutParams.rightMargin=(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8,mcontext.getResources().getDisplayMetrics());
